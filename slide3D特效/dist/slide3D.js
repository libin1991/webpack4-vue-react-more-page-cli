		...
		s.addPagination = function() {
			...
			if(s.params.pagination && s.pagination) {
				...
				for(var i = 0; i < s.totalLength; i++) {
					var bullet = '';
					if(i == 0) {
						bullet = '<span class="slide3D-pagination-bullet';
						bullet += ' slide3D-pagination-bullet-active"></span>';
					} else {
						bullet = '<span class="slide3D-pagination-bullet"></span>';
					};
					bullets.push(bullet);
				};
