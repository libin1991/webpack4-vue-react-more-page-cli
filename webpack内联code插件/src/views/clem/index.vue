...
<article id="app">
  ...
  <div
    ...
    data-content="↓ max-lines & slot `after`"
  />
  <section class="case">
  ...
  <div
    class="divider text-center"
    data-content="↓ max-height & slot `before`"
  />
  <section class="case">
    <div class="form-horizontal">
      <div class="form-group">
